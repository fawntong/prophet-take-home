...
export const DeterminationBadge: React.FC<Props> = ({determination}) => {
    return (
        <Badge  color={getDeterminationBadgeColor(determination)} variant="soft" size="2">
            {determination}
        </Badge>
    )
}

const getDeterminationBadgeColor = (determination: InvestigationDetermination): BadgeProps["color"] => {
